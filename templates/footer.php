<footer class="bg-gray-800 text-white mt-auto py-10">
    <div class="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
            ...
            <button id="pwaInstall" class="bg-green-600 text-white px-4 py-2 rounded font-bold hover:bg-green-700 transition w-full">Install Jiji App</button>
        </div>
    </div>
    <div class="text-center mt-10 border-t border-gray-700 pt-6 text-sm text-gray-500">
        &copy; 2024 Jiji-Inspired-1.0 - All Rights Reserved.
    </div>
</footer>
