...
<div class="container mx-auto px-4 py-16 flex-1">
    <div class="mb-16 text-center">
        <h1 class="text-5xl font-black text-gray-800 uppercase tracking-tighter italic mb-4">The Marketplace <span class="text-green-600">Journal</span></h1>
        ...
        <a href="/blog/<?php echo $post['slug']; ?>" class="bg-white rounded-[2.5rem] overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 border border-gray-100 group">
            ...
            <div class="p-8">
                <div class="flex items-center gap-3 mb-4">
                    <span class="text-[10px] font-black text-green-600 uppercase tracking-widest bg-green-50 px-3 py-1 rounded-full">Articles</span>
                    <span class="text-[10px] font-bold text-gray-300 uppercase"><?php echo date('M d, Y', strtotime($post['created_at'])); ?></span>
                </div>
                <h2 class="text-xl font-black text-gray-800 mb-4 line-clamp-2 group-hover:text-green-600 transition-colors"><?php echo h($post['title']); ?></h2>
                ...
                <div class="flex items-center gap-2 text-xs font-black text-gray-800 uppercase tracking-widest group-hover:gap-4 transition-all">
                    Read More <i class="fas fa-arrow-right text-green-600"></i>
                </div>
            </div>
        </a>
        <?php endforeach; ?>
